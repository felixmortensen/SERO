function sliceThick = sero_pulseq_plotSliceProfile(rfShape, rfTime, gAmp, flipAngle, sliceThick, dz, do_rewind)
% function pulseq_plotSliceProfile(rfShape, rfTime, gAmp, flipAngle, sliceThick, dz, do_rewind)

[M, z, sliceThick] = sero_pulseq_sliceProfile(rfShape, rfTime*1000, flipAngle, mr.convert(gAmp, 'Hz/m', 'mT/m'), sliceThick, do_rewind);
...
[weight, bins] = sero_srr_sliceProf2weight(Mc, z, dz, sliceThick, 0);
