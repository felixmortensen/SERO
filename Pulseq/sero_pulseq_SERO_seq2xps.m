function xps = sero_pulseq_SERO_seq2xps(seq)
% function xps = sero_pulseq_SERO_seq2xps(seq)
%
...
for i = 1:nShot
    [gwf{i}, rf{i}, dt{i}] = sero_pulseq_getShotWaveforms(seq, i);
end
...
[slt, W] = sero_pulseq_seq2sliceThickness(seq, dz);
