function seq = sero_pulseq_SERO_create_v4(E, opt, lims)
% function seq = sero_pulseq_SERO_create_v4(E, opt, lims)
%
...
g = sqrt(maxbValue*1e6/sero_pulseq_calculateBval(1,small_delta,big_delta));
...
for e_ind = 1:nShot
    ...
    t_fill = sero_pulseq_roundToRaster(tShot-(t_end-t_start), lims.img.gradRasterTime);
