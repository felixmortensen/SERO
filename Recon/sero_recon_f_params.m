function param_diff_w = sero_recon_f_params(param_diff, num_edge, lower_val, rampType)
%param_diff_w = sero_recon_f_params(param_diff, num_edge, lower_val, rampType)
