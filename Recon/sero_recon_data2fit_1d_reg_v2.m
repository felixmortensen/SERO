function m = sero_recon_data2fit_1d_reg_v2(S, tr, b, w, do_t1, reg_str, mode, x0, opt, wght, te)
    % function m = sero_recon_data2fit_1d(S, tr, b, w, do_t1, opt, x0, wght, te)
    ...
    function S = par2signal(p, varargin)
        ...
        S = sero_sampling_fit2data(p, tr, b, do_t1, w, te) .* wght;
        ...
        switch mode
            ...
            case 1
                ...
                param_diff = sero_recon_f_params(param_diff, ar); %default is linear ramp filter
