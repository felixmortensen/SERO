function [recon,cmap]=sero_pulseq_coilCombineAdaptive(yn,rn,norm)
% function [recon,cmap]=sero_pulseq_coilCombineAdaptive(yn,rn,norm)

% This function is copied from:
% https://github.com/andyschwarzl/gpuNUFFT/blob/master/matlab/demo/utils/adapt_array_2d.m
...
wsmall=zeros(nc,round(ny./st),round(nx./st));
cmapsmall=zeros(nc,round(ny./st),round(nx./st));
