function sero_pulseq_writeSERO_v2(sampling, fileName, varargin)
...
%Requires first generation SERO sampling scheme (sero_srr_sampling_v3)
...
if strcmp(sampling, 'sero')
    ...
    [~, tr, b] = sero_srr_sampling_v3(ts, nShot, ar, nPos);
    E = pulseq_trb2pos(tr, b, dz);

elseif strcmp(sampling, 'direct')

    [~, tr, b] = sero_srr_conventional(ts, nShot, 1, nPos, 1);
    E = pulseq_trb2pos(tr, b, dz);

elseif strcmp(sampling, 'slice')

    [~, tr, b] = sero_srr_conventional_slice_shift(ts, nShot, ar, nPos, 1);
    E = pulseq_trb2pos(tr, b, dz);
