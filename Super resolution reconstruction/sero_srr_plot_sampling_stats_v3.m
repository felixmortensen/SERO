function sero_srr_plot_sampling_stats_v3(tr, b, w)
%% sero_srr_plot_sampling_stats_v3   Visualize TR & b-value sampling statistics
%   sero_srr_plot_sampling_stats_v3(tr, w, b) makes a 3×2 figure showing:
