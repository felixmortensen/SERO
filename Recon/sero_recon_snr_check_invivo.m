function [SNRmean, STD, E] = sero_recon_snr_check_invivo(fn_nii, fn_fit, fn_xps, fn_msk, do_t1)
% function SNR = sero_recon_snr_check_invivo(fn_nii, fn_fit, fn_xps, fn_msk, do_t1)
