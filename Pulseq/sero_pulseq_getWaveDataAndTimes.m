function [wave_data, tfp_excitation, tfp_refocusing] = sero_pulseq_getWaveDataAndTimes(seq, blockInd)
% function [wave_data, tfp_excitation, tfp_refocusing] = sero_pulseq_getWaveDataAndTimes(seq, blockInd)

[wave_data, tfp_excitation, tfp_refocusing] = seq.waveforms_and_times(true, blockInd);

[indEx, indRef, indSat] = sero_pulseq_getRFBlockInd(seq, blockInd);
