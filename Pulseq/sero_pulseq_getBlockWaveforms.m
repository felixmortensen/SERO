function [gwf, rf, dt, ti, rwf] = sero_pulseq_getBlockWaveforms(seq, blockInd)
% function [gwf, rf, dt, ti, rwf] = sero_pulseq_getBlockWaveforms(seq, blockInd)
...
[wave_data, tfp_excitation, tfp_refocusing] = sero_pulseq_getWaveDataAndTimes(seq, blockInd);
